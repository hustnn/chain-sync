...
use arrow::{
    ...
    datatypes::{
        DataType, Int16Type, Int32Type, Int64Type, Int8Type, Schema as ArrowSchema, SchemaRef as ArrowSchemaRef,
...
pub(crate) fn stringified_partition_value(
    ...
    let s = match data_type {
        ...
        //DataType::Date32 => as_primitive_array::<Chars>(arr).value(0).to_string(),
        // https://github.com/apache/arrow-rs/issues/587
        DataType::Date32 => array_value_to_string(&arr, 0).unwrap(),
        DataType::Utf8 => {
